  ...
  return (
    <div className="sticky bottom-0 mt-auto w-full max-w-4xl mx-auto flex items-center gap-3 panel-raised bg-[var(--surface-0)]/90 backdrop-blur px-3 py-2">
      <button
        ...
        className="hidden md:flex h-8 w-8 items-center justify-center rounded-md text-fg-muted hover:text-fg hover:bg-fill transition-colors"
      >
        <FaBackward size={14} />
      </button>
      <button
      ...
      <div className="hidden lg:flex flex-col gap-y-0.5 ml-4 text-[10px] text-fg-faint select-none">
